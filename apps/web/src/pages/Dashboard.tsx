      ...
      <div className="flex flex-col gap-8">
        ...
        {continueLesson && (
            <Card>
              ...
              <div className="mt-5">
                <ProgressBar value={continueLesson.completedExercises} max={continueLesson.totalExercises || 1} showLabel={false} />
                <p className="mt-2 text-right text-xs font-medium text-(--color-text-soft)">{continueLesson.percentage}%</p>
              </div>
            </Card>
        )}
          ...
          <Card>
            ...
            <div className="mt-5 flex flex-col gap-3">
              {recentAchievements.map((a) => (
                  ...
                  >
                    <div className="size-10 shrink-0 overflow-hidden rounded-full bg-(--color-surface-elevated)">
